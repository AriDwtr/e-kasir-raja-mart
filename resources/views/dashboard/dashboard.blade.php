...
<body>
    ...
    <aside id="default-sidebar"
        ...
        aria-label="Sidebar">
        <div
            class="h-full px-3 py-4 overflow-y-auto border-r-4 border-blue-600 rounded-r-xl bg-blue-50 dark:bg-gray-800">
                ...
                <li>
                    <a href="#"
                        ...
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-black transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white"
